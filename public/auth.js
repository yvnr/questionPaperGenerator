...
signupForm.addEventListener('submit', async (e) => {
    ...
    const fetchPrivateKey = firebase.functions().httpsCallable('fetchPrivateKey');
    fetchPrivateKey({})
        .then(result => {
            if (result.data === key) {
                // sign up the user
        ...
        .catch(err => {
            signupForm.querySelector('.error').innerHTML = 'OOPS! something went wrong on our side, please try again';
        });
